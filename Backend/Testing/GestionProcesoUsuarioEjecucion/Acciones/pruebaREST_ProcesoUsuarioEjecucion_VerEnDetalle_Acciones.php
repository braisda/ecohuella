...
function pruebaREST_ProcesoUsuarioEjecucion_VerEnDetalle_Acciones(){
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    $prueba = 'Ver en detalle un proceso usuario ejecucion';
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    $prueba = 'Ver en detalle una proceso usuario ejecucion que no existe en el sistema';
