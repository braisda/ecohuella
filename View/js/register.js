...
function checkRegisterAdd() {
  if(checkUserDNI("dniP", "errorFormatDni", "personDni") && 
      ...
      checkPhone("telefonoP", "errorFormatPhone","phonePersonRegister") &&
      checkEmail("emailP", "errorFormatEmail", "emailPersonRegister") &&
      checkPass("passUsuario1","errorFormatoPassRegistro","passUserRegister") &&
      checkPassRepAdd("passUsuario2","errorFormatPassRegister2","passUserRegister") &&
      verificarPasswd()) {
        encrypt("passUsuario1");
        return true;
      }
      return false;
}
...
function fillSelectRole() {
  ...
  var rolesArrayCookie = ",,MODERADOR,FORMULADOR,BASICO";
...
function fillSelectRoleAdd() {
  var select = $("#select_id_rol_add");
